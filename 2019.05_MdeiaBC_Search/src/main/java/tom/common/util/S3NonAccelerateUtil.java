...
public class S3NonAccelerateUtil {
	
	
	private AmazonS3 s3Client = null;
	
	private static S3NonAccelerateUtil instance = null;
	private S3NonAccelerateUtil() {	
    ...
    public static synchronized S3NonAccelerateUtil getInstance() {
        if (instance == null) {
            instance = new S3NonAccelerateUtil();
        }
        return instance;
    }
